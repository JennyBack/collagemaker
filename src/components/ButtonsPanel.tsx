...
const ButtonsPanel = ({showEditMode,setShowEditMode,showAddImagesDialog,setShowAddImagesDialog,onDownload}: ButtonsPanelProps) => {
   
    return (
    <Grid xs={12} aria-label={'editing-buttons'} display={'flex'} justifyContent={'flex-end'} alignContent={'center'}
        sx={{
            marginTop: '20px', 
            gap: '20px'
            }} 
